...
void conf_GPIO(){
	GPIOA->MODER |= GPIO_MODER_MODER1_1 | GPIO_MODER_MODER4_1 | GPIO_MODER_MODER6_1 | GPIO_MODER_MODER9_1 | GPIO_MODER_MODER10_1;
	...
	GPIOA->AFR[0] |= setAF(1,1) | setAF(4,13) | setAF(6,13);
